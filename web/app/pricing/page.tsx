  ...
  return (
    <section className="pt-12 pb-20">
      ...
      <div className="mt-10 text-sm text-ink/60 max-w-2xl">
        <p>
          <strong>Bring-your-own Anthropic API key.</strong> Adia uses Claude vision models to watch your screen. You pay Anthropic directly for usage — typical sessions cost a few cents. We never charge you for inference.
        </p>
        <p className="mt-3">
...
function FAQ() {
  const items = [
    {
      q: 'How much does Anthropic API usage cost me?',
      a: 'Typical sessions run a few cents of Anthropic usage. A heavy day of deep work may cost more depending on model pricing and session length. You pay Anthropic directly — we don\'t mark it up.',
    },
    {
