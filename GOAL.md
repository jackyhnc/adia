...
- [x] Self-service license resend: POST /api/license/resend sends key summary email; anti-enumeration (always ok=true); rate-limited 3/15min; /account page; 8 tests
