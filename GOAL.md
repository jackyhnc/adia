...
- [x] Claude API client: async/await wrapper for vision + chat completions, reads ANTHROPIC_API_KEY from ProcessInfo
- [x] On-task detection: send screen CGImage to claude-haiku, classify on-task/off-task/ambiguous with task context
...
- [x] Blocked page: local WKWebView HTML page shown when user hits a blocked URL
