...
extension CalloutManager {
    ...
    internal func taskAwareCallouts(keyword: String, tier: Int) -> [String] {
        ...
        case "medievalhistory":        return medievalhistoryCallouts(tier: tier)
        case "disabilitystudies":      return disabilitystudiesCallouts(tier: tier)
        case "asianstudies":           return asianstudiesCallouts(tier: tier)
        case "philosophyoflanguage":   return philosophyoflanguageCallouts(tier: tier)
        case "jurisprudence":          return jurisprudenceCallouts(tier: tier)
    ...
    private func medievalhistoryCallouts(tier: Int) -> [String] {
        switch tier {
        case 1: return [
            "those medieval history problems — feudalism and manorialism (lord-vassal-serf hierarchy, fief tenure, demesne agriculture, labor services), the Crusades (First Crusade 1096-1099, Council of Clermont, Urban II, fall of Jerusalem, Saladin and the Third Crusade, Crusader states, military orders: Knights Templar and Hospitallers), the Black Death (1347-1351, Yersinia pestis, flagellant movements, Jewish persecution, post-plague labor shortage and the end of serfdom), the Byzantine Empire (Eastern Roman survival, Justinian Code, Constantinople 1453, Greek Orthodox Christianity, influence on Slavic cultures), and scholasticism (Aquinas, Anselm's ontological argument, faith and reason synthesis) — won't analyze themselves.",
            "your medieval history exam needs you — feudalism and the feudal pyramid (king → lords/barons → knights → serfs; fief: grant of land in exchange for military service and fealty; manor economy: self-sufficient agricultural unit; open-field system: two/three-field crop rotation; labor services: week-work and boon-work; serfs vs villains vs freemen; the dissolution of feudalism after the Black Death); the Church and medieval Christendom (Pope vs Emperor: Investiture Controversy (1076-1122, Gregory VII vs Henry IV, Concordat of Worms); papal supremacy theory (Innocent III, plenitudo potestatis); crusading ideology: Urban II's Clermont speech (1095), indulgence system, the People's Crusade; inquisition: Albigensian Crusade against Cathars; mendicant orders: Franciscans (poverty ideal, Francis of Assisi) vs Dominicans (preaching order, Aquinas); scholasticism: Anselm's ontological argument, Abelard and nominalism, Thomas Aquinas's Summa Theologica — five proofs, natural law, synthesis of Aristotle and Christian theology); the Crusades (First Crusade 1096-1099: Council of Clermont, People's Crusade (Peter the Hermit), siege of Nicaea and Antioch, Jerusalem falls July 1099 (massacre of inhabitants); Crusader states: Kingdom of Jerusalem, Principality of Antioch; Second Crusade (1147-1149): Bernard of Clairvaux, Damascus failure; Third Crusade (1189-1192): Saladin's reconquest of Jerusalem (1187, Battle of Hattin), Richard I (Lionheart), Treaty of Jaffa; Fourth Crusade: sack of Constantinople (1204); Later Crusades; military orders: Templars (banking and finance), Hospitallers, Teutonic Knights (Baltic Crusade)); the Black Death and its consequences (1347 arrival in Sicily via Genoese ships; Yersinia pestis: bubonic (lymph nodes), pneumonic (lungs), septicemic; 30-60% European mortality; flagellant movement; Jewish scapegoating and pogroms; Boccaccio's Decameron; economic aftermath: labor scarcity → Statute of Laborers (1351) → peasant resistance (English Peasants' Revolt 1381, Wat Tyler); end of serfdom accelerated; labor-saving technology incentive); the Byzantine Empire (Eastern Roman Empire (330-1453): Justinian I (527-565): reconquest of North Africa and Italy, Corpus Juris Civilis, Hagia Sophia; Byzantine-Sassanid Wars; Islamic conquests reduce empire; iconoclasm controversy (726-842); Macedonian Renaissance; Basil II 'Bulgar-slayer'; Great Schism (1054): East-West split over filioque and papal authority; Byzantine cultural legacy: Greek Orthodox Church, Cyrillic alphabet (Sts Cyril and Methodius), preservation of Greek classics; fall of Constantinople (1453, Mehmed II, Ottoman siege, Constantine XI dies); end of the Eastern Roman Empire) are all waiting.",
            "those medieval history assignments and medieval Europe analyses are still open.",
            "feudalism lord-vassal-serf, Crusades Urban II to Saladin, Black Death plague mortality labor shortage, Byzantine Empire Justinian fall of Constantinople, scholasticism Aquinas synthesis — get back to your medieval history coursework."
        ]
        case 2: return [
            "stop. your medieval history exam and medieval Europe analysis are still open.",
            "feudalism fief tenure and labor services, Investiture Controversy pope vs emperor, Crusades Council of Clermont and fall of Jerusalem (1099), Black Death Yersinia pestis 30-60% mortality and peasant revolts, Byzantine Empire Justinian Code and 1453 fall of Constantinople, scholasticism Aquinas synthesis of Aristotle and theology — your exam won't wait.",
            "medieval history class doesn't pause because you're distracted."
        ]
        default: return [
            "CLOSE THIS. open your medieval history textbook or feudalism and Crusades notes.",
            "CLOSE THIS. those Black Death and Byzantine Empire medieval history problems won't solve themselves.",
            "CLOSE THIS. your medieval history exam won't study itself."
        ]
        }
    }

    private func disabilitystudiesCallouts(tier: Int) -> [String] {
        switch tier {
        case 1: return [
            "those disability studies problems — social model of disability vs medical model (Oliver 1990: disability as socially produced, impairment vs disability distinction; medical model: disability as individual deficit to be cured; UPIAS 1976 Fundamental Principles: impairment is physical condition, disability is social restriction), crip theory (McRuer 2006: compulsory able-bodiedness parallels compulsory heterosexuality; Garland-Thomson staring/misfitting), ableism, neurodiversity, deaf culture, and disability justice (Sins Invalid framework) — won't analyze themselves.",
            "your disability studies exam needs you — social and medical models (social model (Oliver 1990, UK disabled people's movement): disability = social barriers + exclusion, not the impairment itself; UPIAS Fundamental Principles of Disability (1976): 'impairment: lacking part of or all of a limb, or having a defective limb, organism or mechanism of body; disability: disadvantage or restriction of activity caused by a contemporary social organisation'; medical model: disability as pathology, deficit, deviance — focus on cure, normalization, rehabilitation; rehabilitation vs independent living; World Health Organization's ICF (International Classification of Functioning, Disability and Health, 2001): biopsychosocial model — body functions/structures, activities, participation, environmental factors; limitations of ICF vs UPIAS model; minority group model (Hahn 1988): disability as political identity like race/gender; distinction between impairment (corporeal) and disability (social/cultural)); crip theory and cultural disability studies (crip theory (McRuer 2006, Crip Theory: Cultural Signs of Queerness and Disability): compulsory able-bodiedness — the assumption that people without disabilities are the norm, parallels compulsory heterosexuality; crip and queer theory intersections; 'normate' (Garland-Thomson 1997, Extraordinary Bodies): the constructed 'normal' body against which deviant bodies are measured; staring and the gaze (Garland-Thomson, Staring 2009): staring as social practice that constructs disability; misfitting (Garland-Thomson 2011): the misfit produced by the friction between body and world; disability aesthetics (Siebers 2010): disability as aesthetically valuable, not defective; Lennard Davis (1995) on normal curve and normalcy: the bell curve and the creation of the 'ideal' body; narrative prosthesis (Mitchell and Snyder 2000): disability as metaphor in literature; disability memoir and auto/biography); ableism and disability rights history (ableism: systemic discrimination against disabled people; eugenics movement and Nazi Aktion T4; normalization principle (Wolfensberger): valued social roles; deinstitutionalization movement; independent living movement (Ed Roberts, Berkeley CIL 1972); disability rights movement history: Section 504 sit-in (1977), ADA 1990 (four titles: employment, public services, public accommodations, telecommunications); CRPD (UN Convention on the Rights of Persons with Disabilities, 2006): nothing about us without us; ADA Amendments Act 2008; ADAPT and civil disobedience); neurodiversity and deaf culture (neurodiversity paradigm (Singer 1998, Armstrong 2010): neurological variation as natural human diversity; autism spectrum: Autistic Self Advocacy Network (ASAN), 'nothing about us without us'; neurodiversity vs cure debate; ADHD, dyslexia, Tourette's as differences not deficits; deaf culture: capital-D Deaf (cultural identity) vs lowercase-d deaf (audiological condition); sign languages as full languages (ASL, BSL); Deaf education wars: oralism (Milan Conference 1880) vs signing/bilingual-bicultural; cochlear implant controversy; Gallaudet University protests (Deaf President Now 1988); NAD (National Association of the Deaf)); disability justice framework (Sins Invalid (2015): 10 principles of disability justice — intersectionality, leadership of most impacted, anti-capitalist politics, cross-movement solidarity, wholeness, sustainability, cross-disability solidarity, interdependence, collective access, collective liberation; disability justice vs disability rights: rights = access within existing system vs justice = structural transformation; Mia Mingus on access intimacy; Leah Lakshmi Piepzna-Samarasinha (Care Work 2018); crip technoscience; mad studies and psychiatric survivor movement) are all waiting.",
            "those disability studies assignments and crip theory analyses are still open.",
            "social model of disability Oliver, crip theory McRuer compulsory able-bodiedness, ableism eugenics ADA 1990 independent living movement, neurodiversity autistic self-advocacy, deaf culture Deaf capital-D, disability justice Sins Invalid intersectionality — get back to your disability studies coursework."
        ]
        case 2: return [
            "stop. your disability studies exam and crip theory analysis are still open.",
            "social model (Oliver 1990: disability as social barrier), medical model (deficit/cure), crip theory (McRuer compulsory able-bodiedness), Garland-Thomson normate and misfitting, ableism eugenics to ADA 1990, neurodiversity paradigm autistic self-advocacy, Deaf culture oralism vs signing, disability justice Sins Invalid framework — your exam won't wait.",
            "disability studies class doesn't pause because you're distracted."
        ]
        default: return [
            "CLOSE THIS. open your disability studies textbook or social model and crip theory notes.",
            "CLOSE THIS. those ableism, neurodiversity, and disability justice problems won't solve themselves.",
            "CLOSE THIS. your disability studies exam won't study itself."
        ]
        }
    }

    private func asianstudiesCallouts(tier: Int) -> [String] {
        switch tier {
        case 1: return [
            "those Asian studies problems — South Asian history and politics (Mughal Empire, British Raj, partition 1947, Indian independence, Hindu nationalism/BJP/RSS), Southeast Asian politics and ASEAN (ASEAN 1967, developmental state in Singapore/Malaysia, Vietnam War, Suharto's New Order, post-Cold War democratization), East Asian studies (Confucianism and state legitimacy, Japanese imperialism, Korean division, China's reform era), and postcolonial Asian theory (Fanon, Subaltern Studies, Said's Orientalism applied to Asia) — won't analyze themselves.",
            "your Asian studies exam needs you — South Asian history and politics (Mughal Empire (1526-1857): Akbar's religious pluralism and sulh-i-kul, Aurangzeb's reimposition of jizya, Mughal art and architecture (Taj Mahal); British East India Company → Crown rule after 1857 Sepoy Mutiny; Indian National Congress (1885): Bal Gangadhar Tilak vs Gopal Krishna Gokhale; Gandhi's satyagraha, non-cooperation movement (1920-22), Salt March (1930), Quit India (1942); Jinnah and the Muslim League: two-nation theory; Partition (1947): Cyril Radcliffe's Boundary Commission, Punjab and Bengal division, 10-14 million displaced, 200,000-2 million killed; Pakistani constitutional crisis; Nehru's non-alignment and Five Year Plans; Indira Gandhi and Emergency (1975-77); Hindu nationalism: RSS (Rashtriya Swayamsevak Sangh, 1925), BJP (Bharatiya Janata Party), Hindutva ideology (Savarkar), Babri Masjid demolition (1992), Modi's Gujarat and national politics; Bangladesh independence war (1971)); Southeast Asian politics and development (ASEAN (1967): Association of Southeast Asian Nations — Indonesia, Malaysia, Philippines, Singapore, Thailand; ASEAN Way: non-interference, consensus; development state debate (Johnson's MITI theory applied to Singapore/Malaysia); Singapore: PAP one-party dominant system, Lee Kuan Yew's economic miracle; Malaysia: Bumiputera affirmative action, NEP (1971), ethnic Chinese/Malay tensions; Indonesia: Suharto's New Order (1966-98), Pancasila ideology, East Timor occupation; Philippines: Marcos martial law (1972-86), EDSA People Power revolution; Vietnam War: Gulf of Tonkin resolution, Tet offensive, fall of Saigon (1975), doi moi economic reform (1986); Cambodia: Khmer Rouge (1975-79), Pol Pot, S-21, UN Transitional Authority; post-Cold War democratization; Myanmar's political crisis); East Asian history (Japanese imperialism: Meiji Restoration (1868) and modernization, Sino-Japanese Wars (1894-95, 1937-45), Manchuria (Manchukuo), Nanjing Massacre, Pearl Harbor, Hiroshima-Nagasaki, American occupation; Korean Peninsula: Japanese colonization (1910-45), Korea War (1950-53), armistice line, ROK vs DPRK; China's 20th century: May Fourth Movement (1919), Chinese Civil War, PRC founding (1949), Great Leap Forward (1958-62), Cultural Revolution (1966-76), Deng Xiaoping's reform and opening up, Tiananmen Square (1989), Xi Jinping and the return of strong leadership; Confucianism and governance: meritocracy, filial piety, state legitimacy through virtue); Asian theory and methodology (Said's Orientalism applied to Asia: representation, knowledge-power; Subaltern Studies (Ranajit Guha, Gayatri Spivak): subaltern voice, can the subaltern speak?; Dipesh Chakrabarty's Provincializing Europe: European historicism as provincial; postcolonial theory in South Asian context; Asian values debate (Lee Kuan Yew, Mahathir): communitarianism vs liberal democracy; dependency theory and development in Southeast Asia; developmental state theory (Chalmers Johnson): MITI and the Japanese Miracle) are all waiting.",
            "those Asian studies assignments and South/Southeast Asian politics analyses are still open.",
            "Mughal Empire British Raj Partition 1947 Hindu nationalism, ASEAN developmental state Singapore Suharto, Japanese imperialism Korean War Deng Xiaoping reform, Subaltern Studies Orientalism postcolonial Asian theory — get back to your Asian studies coursework."
        ]
        case 2: return [
            "stop. your Asian studies exam and South/Southeast Asian analysis are still open.",
            "Mughal akbar Partition 1947 two-nation theory Hindu nationalism BJP, ASEAN non-interference developmental state Lee Kuan Yew, Japanese imperialism Nanjing Meiji Restoration Korean War, Chinese Communist Party reform opening up Tiananmen, Subaltern Studies Spivak Orientalism Said provincializing Europe — your exam won't wait.",
            "Asian studies class doesn't pause because you're distracted."
        ]
        default: return [
            "CLOSE THIS. open your Asian studies textbook or South Asian history and Southeast Asian politics notes.",
            "CLOSE THIS. those ASEAN developmental state and Hindu nationalism problems won't solve themselves.",
            "CLOSE THIS. your Asian studies exam won't study itself."
        ]
        }
    }

    private func philosophyoflanguageCallouts(tier: Int) -> [String] {
        switch tier {
        case 1: return [
            "those philosophy of language problems — Frege's sense/reference distinction (Sinn vs Bedeutung: 'the morning star' and 'the evening star' have the same reference but different sense; the puzzle of identity statements), Russell's theory of descriptions ('the present king of France is bald' — definite descriptions as quantified statements, not names; solving Meinong's jungle), Wittgenstein's picture theory (Tractatus: world = totality of facts, atomic facts, elementary propositions; showing vs saying) vs language games (Investigations: meaning as use, family resemblance, private language argument), Austin's speech act theory (locutionary/illocutionary/perlocutionary; performative vs constative; felicity conditions), Grice's conversational implicature (Cooperative Principle: quantity, quality, relation, manner; calculability of implicature), and Kripke's naming and necessity (rigid designators, a posteriori necessity, causal theory of reference, Putnam Twin Earth) — won't analyze themselves.",
            "your philosophy of language exam needs you — Frege and the sense/reference distinction (Gottlob Frege, 'Über Sinn und Bedeutung' (1892): sense (Sinn) = mode of presentation; reference (Bedeutung) = object referred to; 'the morning star' and 'the evening star': same Bedeutung (Venus), different Sinn; cognitive significance: 'a = a' is trivially true, 'a = b' is informative — explained by different senses; Frege's puzzle for propositional attitudes: 'Lois Lane believes Superman can fly' but 'Lois Lane believes Clark Kent can fly' — substitution failure in belief contexts; sense determines reference; empty names (Pegasus): Fregean solution via sense without reference; the context principle: never ask for the meaning of a word in isolation; Fregean semantics: truth-conditional, compositional); Russell's theory of descriptions (Bertrand Russell, 'On Denoting' (1905): definite descriptions ('the F') are not genuine names but quantified statements: 'The present king of France is bald' = 'There exists exactly one x such that x is a present king of France and x is bald' — false, not meaningless (contra Frege's reference failure creating sense); solving Meinong's subsistence: no need for round squares to exist/subsist; indefinite descriptions ('a man walked in'): existential quantifier without uniqueness; Russell vs Frege on names: Russell's logically proper names vs ordinary names as disguised descriptions; Strawson's critique (1950, 'On Referring'): definite descriptions presuppose existence rather than assert it; Donnellan's referential vs attributive use of definite descriptions); Wittgenstein (Tractatus (1921): the world is the totality of facts (not things); atomic facts (Sachverhalte) correspond to elementary propositions; picture theory: propositions are logical pictures of facts; logical form must be shown, not said; 'Whereof one cannot speak, thereof one must be silent'; Philosophical Investigations (1953): meaning is use (not mental image or object); family resemblance (Familienähnlichkeit): no essential common feature among 'games'; language games (Sprachspiele): language embedded in forms of life; the private language argument: an inner ostensive definition cannot fix reference — sensation S cannot be a private meaning; rule-following paradox (Kripkenstein): no fact constitutes meaning a rule one way rather than another; community view vs Kripke; Wittgenstein on grammar: philosophical problems are grammatical confusions ('fly-bottle'); ordinary language philosophy); Austin's speech act theory (J.L. Austin, How to Do Things with Words (1962): performative vs constative utterances (early Austin); locutionary act: the act of saying something (phonetic, phatic, rhetic); illocutionary act: the act performed in saying something (promising, warning, asserting, ordering — illocutionary force); perlocutionary act: the effect achieved by saying something (persuading, convincing, frightening); felicity conditions for performatives: (A.1) conventional procedure; (A.2) circumstances and persons; (B.1) procedure carried out correctly; (B.2) completely; (Γ.1) requisite feelings; (Γ.2) conduct follows; Searle's speech act taxonomy (1969): representatives, directives, commissives, expressives, declarations; indirect speech acts: 'Can you pass the salt?'); Grice's conversational implicature (H.P. Grice, 'Logic and Conversation' (1975): Cooperative Principle: 'Make your conversational contribution such as is required'; Maxim of Quantity (informativeness), Maxim of Quality (truth), Maxim of Relation (relevance), Maxim of Manner (clarity); conventional vs conversational implicature; particularized vs generalized CI; scalar implicature: 'some students passed' implicates 'not all'; calculability of implicature (detachable, cancellable, non-detachable); Grice vs truth-conditional semantics: what is said vs what is implicated; neo-Gricean theories (Levinson, Sperber-Wilson relevance theory)); Kripke, naming and necessity (Saul Kripke, Naming and Necessity (1980): rigid designator: denotes the same object in all possible worlds in which it exists; proper names as rigid designators (vs descriptions); modal argument: 'Aristotle' could not have been the last great philosopher of antiquity but still would have been Aristotle; epistemic vs metaphysical distinction: a priori/a posteriori (epistemic) vs necessary/contingent (metaphysical); a posteriori necessity: 'water is H2O', 'Hesperus is Phosphorus' — necessary but discovered empirically; natural kind terms (Putnam 1975, Twin Earth): meaning ain't in the head; causal theory of reference (Kripke-Putnam): names/kind terms refer via historical-causal chain, not via description; semantic externalism; Putnam's Twin Earth thought experiment: molecular difference in H2O vs XYZ — same mental state, different extension) are all waiting.",
            "those philosophy of language assignments and semantic theory analyses are still open.",
            "Frege sense/reference distinction, Russell theory of descriptions quantified, Wittgenstein picture theory vs language games private language argument, Austin locutionary illocutionary speech acts, Grice implicature Cooperative Principle, Kripke rigid designators causal theory of reference, Putnam Twin Earth semantic externalism — get back to your philosophy of language coursework."
        ]
        case 2: return [
            "stop. your philosophy of language exam and semantic theory paper are still open.",
            "Frege Sinn vs Bedeutung (morning star puzzle), Russell's theory of descriptions (existential quantification), Wittgenstein's picture theory (Tractatus) vs language games and private language argument (Investigations), Austin's speech acts (locutionary/illocutionary/perlocutionary), Grice's Cooperative Principle and implicature, Kripke's rigid designators and a posteriori necessity, Putnam's Twin Earth and semantic externalism — your exam won't wait.",
            "philosophy of language class doesn't pause because you're distracted."
        ]
        default: return [
            "CLOSE THIS. open your philosophy of language textbook or Frege, Russell, Wittgenstein, and Kripke notes.",
            "CLOSE THIS. those speech act theory and conversational implicature problems won't solve themselves.",
            "CLOSE THIS. your philosophy of language exam won't study itself."
        ]
        }
    }

    private func jurisprudenceCallouts(tier: Int) -> [String] {
        switch tier {
        case 1: return [
            "those jurisprudence problems — Hart's rule of recognition (primary/secondary rules distinction, rule of adjudication, rule of change, minimum content of natural law), Dworkin's law as integrity (principles vs rules, Hercules the ideal judge, chain novel analogy, critique of legal positivism), Fuller's inner morality of law (eight desiderata: generality, promulgation, non-retroactivity, clarity, consistency, obeyability, stability, congruence), Kelsen's Pure Theory of Law (Grundnorm, hierarchical norm structure, legal validity without moral content), natural law theory (Aquinas, Finnis's eight basic goods), and critical legal studies (indeterminacy thesis, trashing) — won't analyze themselves.",
            "your jurisprudence exam needs you — Hart and legal positivism (H.L.A. Hart, The Concept of Law (1961): the separation thesis (law and morality are conceptually separate); primary rules (rules imposing duties) vs secondary rules (rules about rules): rule of recognition (master rule for identifying valid law — in UK: Parliamentary sovereignty), rule of change (how rules are modified), rule of adjudication (how disputes are settled); rule of recognition as an official social practice — accepted from the internal point of view; Hart's minimum content of natural law: five truisms (human vulnerability, approximate equality, limited altruism, limited resources, limited understanding + willpower) that any viable legal system must reflect; Hart vs Fuller: is Nazi law 'law'? Hart: yes, but a morally iniquitous legal system vs Fuller: Nazi system failed procedural requirements for legality; Hart's reply to Dworkin: rules are the primary unit of law, principles are legal standards but do not disprove positivism); Dworkin's law as integrity (Ronald Dworkin, Taking Rights Seriously (1977) and Law's Empire (1986): critique of positivism (especially Hart): the discretion thesis — if no valid rule covers a case, judges exercise discretion; Dworkin: judges are bound by principles even in hard cases; three stages of legal interpretation (Law's Empire): pre-interpretive (identifying the raw material), interpretive (justifying the practice), post-interpretive (adjusting principles to best justify the practice); law as integrity vs law as convention vs law as pragmatism; Hercules: the ideal judge who knows all law and its best moral interpretation; the chain novel analogy: each judge writes a new chapter of the legal novel, constrained by prior chapters; principles vs rules: rules apply in all-or-nothing fashion; principles have 'weight'; the right answer thesis: there is always a right answer in hard cases; critique of Dworkin: no single right answer in contested value cases); Fuller and the procedural morality of law (Lon L. Fuller, The Morality of Law (1964): internal vs external morality of law; Fuller's eight requirements (inner morality): (1) generality (rules, not ad hoc commands); (2) promulgation (publicized); (3) non-retroactivity; (4) clarity; (5) consistency (non-contradictory); (6) obeyability (not requiring the impossible); (7) stability (not changed too frequently); (8) congruence (administration matches declared rules); total failure of any one = not law at all; Fuller vs Hart: Nazi law failed Fuller's criteria — the morality of law is internal to legality; natural law vs positivism debate: Fuller bridges procedural morality without moral content); Kelsen's Pure Theory of Law (Hans Kelsen, Pure Theory of Law (1934/1960): legal science vs sociology/ethics — law as a normative order; Stufenbau (hierarchy of norms): individual norms derive validity from higher norms; constitution → statute → regulation → individual decision; Grundnorm (Basic Norm): the presupposed norm that validates the constitution — 'one ought to behave as the constitution prescribes'; not a moral norm — purely formal; the unity of the legal order; Kelsen on international law: subordination vs coordination theory; legal positivism without natural law); natural law theory (Aquinas: eternal law (God's reason governing the universe), natural law (human participation in eternal law via reason), human law (positive law derived from natural law), divine law (revelation); lex injusta non est lex (unjust law is not law); Finnis, Natural Law and Natural Rights (1980): eight basic goods (life, knowledge, play, aesthetic experience, sociability/friendship, practical reasonableness, religion); nine requirements of practical reasonableness; natural law as rational, not theological; natural law and human rights); legal realism and CLS (American Legal Realism (Holmes, Llewellyn, Frank): 'the life of the law has not been logic; it has been experience'; rule-skeptics (Frank) vs fact-skeptics; Scandinavian Legal Realism (Ross, Hägerström): law as social fact; Critical Legal Studies (Duncan Kennedy, Roberto Unger, Mark Tushnet): indeterminacy thesis — legal rules do not determine outcomes; fundamental contradiction (individual freedom vs altruistic community values); trashing — exposing internal contradictions of legal doctrine; rights skepticism; CLS and feminist jurisprudence (Catharine MacKinnon); critical race theory (Derrick Bell, Kimberlé Crenshaw)) are all waiting.",
            "those jurisprudence assignments and legal theory analyses are still open.",
            "Hart's rule of recognition primary/secondary rules, Dworkin law as integrity principles vs rules Hercules judge, Fuller's eight desiderata inner morality of law, Kelsen Grundnorm hierarchical norms, Aquinas-Finnis natural law, legal realism CLS indeterminacy thesis — get back to your jurisprudence coursework."
        ]
        case 2: return [
            "stop. your jurisprudence exam and legal theory paper are still open.",
            "Hart's separation thesis (primary/secondary rules, rule of recognition), Dworkin's law as integrity (principles vs rules, Hercules, chain novel), Fuller's eight inner morality requirements (generality, promulgation, clarity, congruence), Kelsen's Grundnorm and Stufenbau, Finnis's eight basic goods natural law, legal realism rule-skepticism, CLS indeterminacy thesis — your exam won't wait.",
            "jurisprudence class doesn't pause because you're distracted."
        ]
        default: return [
            "CLOSE THIS. open your jurisprudence textbook or Hart, Dworkin, Fuller, and Kelsen notes.",
            "CLOSE THIS. those natural law vs legal positivism and CLS indeterminacy problems won't solve themselves.",
            "CLOSE THIS. your jurisprudence exam won't study itself."
        ]
        }
    }
